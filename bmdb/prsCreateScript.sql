...
-- cant get insert statement to run due to "data to long for column name" researching it said i need to take mysql off of "strict mode" could you try inserting and seeing if it works on your machine?
...
('3', '3', '105810', 'hammermill paper, premium multi-purpose paper polywrap', '8.99', null, null),
('4', '4', '122374', 'hammermill copy plus copy paper, 81/2 x 11, case', '29.99',null,  null),
